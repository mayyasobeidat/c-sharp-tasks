                    ...
                    <div class="row g-4">
                        <div class="col-sm-6 col-sm-3">
                           ...
                           <div class="col-sm-6 col-sm-3">
                            <div class=" rounded d-flex align-items-center justify-content-around p-4" style="background-color:#2672AB ;">
                                <div class="ms-3">
                                    <p class="statText" style="color: white;"><span class="test1" style="font-size:14px;">Non-Completed Surveys</span></p>
                       ...
                       <div class="col-sm-6 col-sm-3">
                        ...
                        <div class="col-sm-6 col-sm-3">
                            <div class=" rounded d-flex align-items-center justify-content-around p-4" style="background-color:#2672AB ;">
                                <div class="ms-3">
                                    <p class="statText" style="color: white; "> <span class="test1" style="font-size:15px;">Missing Surveys</span></p>
